...
(function (global) {
  ...
  const messages = {
    en: {
      ...
      'static.fastHint': 'Orthographic projection, parallel light, no cast shadows. Spheres overlap by depth; only local bond–atom occlusion is handled. Turning this off restores the previous lighting settings.',
      ...
      'static.pointLight': 'Point light',
      'static.lightDistance': 'Light distance',
      'static.attenuation': 'Attenuation strength',
      'static.attenuationHint': '0 means no attenuation',
    ...
    'zh-CN': {
      ...
      'static.fastHint': '正交投影、平行光、无投影阴影。球体按深度覆盖，仅处理键与原子的局部遮挡；关闭后恢复原光照设置。',
      'static.texture': '纹理',
      ...
      'static.pointLight': '点光源',
      'static.lightDistance': '光源距离',
      'static.attenuation': '衰减强度',
      'static.attenuationHint': '0 表示不衰减',
